...
git clone https://github.com/rothfels/spartify.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/spartify/$SLUG/g" **/*.tf
sed -i.bak "s/spartify/$SLUG/g" **/*.ts
sed -i.bak "s/spartify/$SLUG/g" **/*.yml
sed -i.bak "s/spartify/$SLUG/g" **/*.sh
sed -i.bak "s/spartify/$SLUG/g" **/*.json
rm -rf **/*.bak
