...
usage="Usage: deploy-ecs.sh [spartify-app-web|spartify-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/spartify:$2"
...
aws ecs update-service --cluster spartify \
  --no-cli-pager \
  --region "$ecs_region" \
