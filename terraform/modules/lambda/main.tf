...
# Lambda URIs are "{+lambda}/{+function}" e.g. "spartify/ping".
# We also support path matching at the root e.g. "spartify" but these require definining separate "_root" terraform resources.
